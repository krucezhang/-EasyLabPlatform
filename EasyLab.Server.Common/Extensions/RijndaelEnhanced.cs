namespace EasyLab.Server.Common.Extensions
{
    ...
    public class RijndaelEnhanced
    {
        ...
        // PassPhrase, can be used by all with Default Constructor
        private static string passPhrase = "nitraMekaD";        // can be any string
        // Vector, can be used by all with Default Constructor
        private static string initVector = "MED 000BDB80F312"; // must be 16 bytes
        ...
        #region Constructors
        /// Use this contructor if you wish to use the Private Static Members for the 
        /// PassPhrase and Vector
